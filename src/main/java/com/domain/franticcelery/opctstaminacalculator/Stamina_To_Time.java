package com.domain.franticcelery.opctstaminacalculator;
...
public class Stamina_To_Time extends AppCompatActivity {
	...
	private int neededStam;


	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_stamina__to__time);
